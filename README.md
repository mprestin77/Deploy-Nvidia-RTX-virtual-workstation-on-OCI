...
BM.GPU.A10.4
```
When launching a compute instance change compute shape to one of the these shapes. For VMs click on Specialty and Previous Generation, and select one of VM.GPU.A10 shapes. For bare metal servers click on Bare metal machines and select BM.GPU.A10.4 shape.
